...
from data_loader import NormalMnistLoader
...
parser.add_argument("--method", type=str, default="drop_connect_test")
...
if __name__ == "__main__":
    ...
    data = NormalMnistLoader(flatten=config["flatten"], data_path=args.data_dir)
